...
struct IconPickerView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        return IconPickerView(iconTapAction: printString)
            .environmentObject(SelectedThemeColors())
    }
}
