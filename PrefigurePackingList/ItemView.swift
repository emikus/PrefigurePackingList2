...
struct ItemView: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: $showingSelectedActivityItemRemovalAlert) {
            Alert(title: Text("This item belong to the activity you've selected before. Are you sure you want to delete it from your bag?"), message: Text("You can always add it back"), primaryButton: .destructive(Text("Delete")) {
                    self.addRemoveItemToBag()
